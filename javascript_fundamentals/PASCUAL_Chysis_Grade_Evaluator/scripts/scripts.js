...
document.getElementById("yourGrade").onchange = (event) => {
    ...
    if(grade >= 75){
        card.getElementsByClassName("card-title")[0].innerText = "Congratulations Mamamia!! MAYBE YOU PASSED!!!";
        card.classList.add("text-bg-success");
    }else{
        card.getElementsByClassName("card-title")[0].innerText = "OOPPSYAH!! MAYBE YOU FAILED!!!";
